...
;(function()
{
	...
	function Brush()
	{
      ...
      'xcode_settings coverage profiles symbols type ' +
      '';

		var funcs =
      'variables targets actions rules copies conditions target_conditions target_defaults' +
      '' +
      '';
    ...
    this.getGypKeywords = function(keywords) {
      ...
      console.log(this.getKeywords('\'' + keywords.replace(/  */g, '\' \'')));
      console.log(this.getKeywords('asdf asdfsdf'));
      return this.getKeywords(keywords)
      return this.getKeywords('\'' + keywords.replace(/  */g, '\' \'') + '\'');
    }

		this.regexList = [
				{ regex: SyntaxHighlighter.regexLib.singleLinePerlComments, css: 'comments' },
				{ regex: new RegExp(this.getGypKeywords(funcs), 'gmi'),		css: 'keyword' },
				{ regex: new RegExp(this.getGypKeywords(keywords), 'gm'), 		css: 'keyword' },
				{ regex: new RegExp(this.getGypKeywords(special), 'gm'), 		css: 'functions' }
				];
